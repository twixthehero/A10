...
bool MyBoundingObjectClass::CheckCollision(MyBoundingObjectClass* const a_pOther)
{
	...
	vector3 vMin1 = vector3(worldMatrix * vector4(min, 1.0f));
	vector3 vMax1 = vector3(worldMatrix * vector4(max, 1.0f));
	vector3 vMin2 = vector3(a_pOther->worldMatrix * vector4(a_pOther->min, 1.0f));
	vector3 vMax2 = vector3(a_pOther->worldMatrix * vector4(a_pOther->max, 1.0f));
